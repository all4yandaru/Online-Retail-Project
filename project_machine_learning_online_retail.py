...
path = '/content/drive/Shareddrives/Machine Learning - Project/Project Online Retail/online_retail_II.csv'
...
today_date = dt.datetime(date_split[0],date_split[1],date_split[2]) # last invoice date is assigned to today_date variable
